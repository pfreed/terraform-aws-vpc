...
| <a name="input_database_subnet_ipam_netmask_lengths"></a> [database\_subnet\_ipam\_netmask\_lengths](#input\_database\_subnet\_ipam\_netmask\_lengths) | List of netmask lengths for IPAM-allocated database subnets. The number of entries controls how many subnets are created, mapped to AZs from var.azs. Requires create\_vpc\_ipam\_pool = true. When set, database\_subnets CIDR values are ignored. | `list(number)` | `[]` | no |
...
| <a name="input_elasticache_subnet_ipam_netmask_lengths"></a> [elasticache\_subnet\_ipam\_netmask\_lengths](#input\_elasticache\_subnet\_ipam\_netmask\_lengths) | List of netmask lengths for IPAM-allocated elasticache subnets. The number of entries controls how many subnets are created, mapped to AZs from var.azs. Requires create\_vpc\_ipam\_pool = true. When set, elasticache\_subnets CIDR values are ignored. | `list(number)` | `[]` | no |
...
| <a name="input_intra_subnet_ipam_netmask_lengths"></a> [intra\_subnet\_ipam\_netmask\_lengths](#input\_intra\_subnet\_ipam\_netmask\_lengths) | List of netmask lengths for IPAM-allocated intra subnets. The number of entries controls how many subnets are created, mapped to AZs from var.azs. Requires create\_vpc\_ipam\_pool = true. When set, intra\_subnets CIDR values are ignored. | `list(number)` | `[]` | no |
...
| <a name="input_private_subnet_ipam_netmask_lengths"></a> [private\_subnet\_ipam\_netmask\_lengths](#input\_private\_subnet\_ipam\_netmask\_lengths) | List of netmask lengths for IPAM-allocated private subnets. The number of entries controls how many subnets are created, mapped to AZs from var.azs. Requires create\_vpc\_ipam\_pool = true. When set, private\_subnets CIDR values are ignored. | `list(number)` | `[]` | no |
...
| <a name="input_public_subnet_ipam_netmask_lengths"></a> [public\_subnet\_ipam\_netmask\_lengths](#input\_public\_subnet\_ipam\_netmask\_lengths) | List of netmask lengths for IPAM-allocated public subnets. The number of entries controls how many subnets are created, mapped to AZs from var.azs. Requires create\_vpc\_ipam\_pool = true. When set, public\_subnets CIDR values are ignored. | `list(number)` | `[]` | no |
...
| <a name="input_redshift_subnet_ipam_netmask_lengths"></a> [redshift\_subnet\_ipam\_netmask\_lengths](#input\_redshift\_subnet\_ipam\_netmask\_lengths) | List of netmask lengths for IPAM-allocated redshift subnets. The number of entries controls how many subnets are created, mapped to AZs from var.azs. Requires create\_vpc\_ipam\_pool = true. When set, redshift\_subnets CIDR values are ignored. | `list(number)` | `[]` | no |
