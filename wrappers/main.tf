module "wrapper" {
  ...
  database_subnet_ipam_netmask_lengths                             = try(each.value.database_subnet_ipam_netmask_lengths, var.defaults.database_subnet_ipam_netmask_lengths, [])
  ...
  elasticache_subnet_ipam_netmask_lengths                           = try(each.value.elasticache_subnet_ipam_netmask_lengths, var.defaults.elasticache_subnet_ipam_netmask_lengths, [])
  ...
  intra_subnet_ipam_netmask_lengths                            = try(each.value.intra_subnet_ipam_netmask_lengths, var.defaults.intra_subnet_ipam_netmask_lengths, [])
  ...
  private_subnet_ipam_netmask_lengths                            = try(each.value.private_subnet_ipam_netmask_lengths, var.defaults.private_subnet_ipam_netmask_lengths, [])
  ...
  public_subnet_ipam_netmask_lengths                            = try(each.value.public_subnet_ipam_netmask_lengths, var.defaults.public_subnet_ipam_netmask_lengths, [])
  ...
  redshift_subnet_ipam_netmask_lengths                           = try(each.value.redshift_subnet_ipam_netmask_lengths, var.defaults.redshift_subnet_ipam_netmask_lengths, [])
